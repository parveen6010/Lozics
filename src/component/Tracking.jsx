...
const Tracking = () => {
  ...
  return (
    <section className="bg-gray-300 flex items-center justify-center h-screen">
      <div>
...
// function onCaptchVerify() {
//   console.log("Auth object:", auth); // Log the auth object to check if it's defined
//   if (!window.recaptchaVerifier) {
//     console.log("RecaptchaVerifier not initialized");
//     window.recaptchaVerifier = new RecaptchaVerifier(
//       "recaptcha-container",
//       {
//         size: "invisible",
