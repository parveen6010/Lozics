  ...
  return (
    <div className='w-screen lg:bg-gray-200 h-screen '>
      <div className='lg:pl-[18px] lg:pt-[6px]'>
        ...
        <div className='lg:flex '>
  <div className='lg:flex' > 
    <button className='lg:bg-blue-500 lg:px-4 lg:py-2 lg:mr-2 lg:rounded-xl lg:border-4  lg:text-white '>Submit</button>
    <button className='lg:bg-blue-500 lg:px-4 lg:py-2 lg:rounded-xl lg:border-4 lg:text-white '>Discard</button>
  </div>
  <div className='lg:ml-[78.5%]'>
    <button className='lg:bg-blue-500 lg:px-4 lg:py-2 lg:rounded-xl lg:border-4 lg:text-[20px] lg:text-white '><FiAlignJustify />
</button>
  </div>
</div>
        <div className="container lg:w-[98%] lg:bg-white lg:h-[900px] ">
         ...
         <button className=' lg:mt-[10px] lg:text-white  lg:flex  lg:ml-[8px] lg:w-[98.5%] lg:py-2 lg:bg-blue-500'>
         ...
         <button className='lg:ml-[5px] lg:mt-[10px] lg:bg-blue-500 lg:px-4 lg:py-2 lg:mr-2 lg:rounded-xl lg:border-4  lg:text-white '>Add item</button>
         ...
         <div style={{overflowX: 'auto', width: '100%', height: 'auto'}}>
           ...
           <div className='  lg:flex lg:ml-2 lg:mt-4  lg:w-[155%] lg:h-[5%]  '>
             ...
             <div className='lg:bg-blue-500 lg:w-[5%] lg:h-100 lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '><IoMdMail /></div>
             <div className='lg:bg-blue-500 lg:w-[5%] lg:h-100 lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '><ImBin /></div>        
             <div className='lg:bg-blue-500 lg:w-[5%] lg:h-100 lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>#</div>        
          
           <div className='lg:flex lg:flex-col lg:w-[45%]'>
           <div className='lg:bg-blue-500 lg:w-[100%] lg:h-[100%] lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>Invoice</div>
           <div className='lg:flex lg:w-full'>
             <div className='lg:bg-blue-500 lg:w-[50%] lg:h-[100%] lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>No.</div>        
             <div className='lg:bg-blue-500 lg:w-[50%] lg:h-[100%] lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>Date</div> 
             </div>    
           </div>
           <div className='lg:bg-blue-500 lg:w-[5%] lg:h-100 lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>pkgs</div>        

           <div className='lg:flex lg:flex-col lg:w-[40%]'>
           <div className='lg:bg-blue-500 lg:w-[100%] lg:h-[100%] lg:border-2  lg:text-white  lg:flex lg:items-center  lg:justify-center   '>weight</div>
           <div className='lg:flex lg:w-full'>
             <div className='lg:bg-blue-500 lg:w-[50%] lg:h-[100%] lg:border-2  lg:text-white lg:flex lg:items-center  lg:justify-center    '>Net</div>        
             <div className='lg:bg-blue-500 lg:w-[50%] lg:h-[100%] lg:border-2  lg:text-white lg:flex lg:items-center  lg:justify-center    '>Fare</div> 
             <div className='lg:bg-blue-500 lg:w-[50%] lg:h-[100%] lg:border-2  lg:text-white  lg:flex lg:items-center  lg:justify-center   '>Container</div> 
             <div className='lg:bg-blue-500 lg:w-[50%] lg:h-[100%] lg:border-2  lg:text-white  lg:flex lg:items-center  lg:justify-center   '>Gross</div> 
             </div>    
           </div>
           <div className='lg:bg-blue-500 lg:w-[15%] lg:h-100 lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>Content</div>        
             <div className='lg:bg-blue-500 lg:w-[15%] lg:h-100 lg:border-2 lg:text-white lg:flex lg:items-center  lg:justify-center    '>Remarks</div>        
